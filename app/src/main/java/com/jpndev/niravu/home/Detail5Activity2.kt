...
class Detail5Activity2 : NiravuActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        item?.let {
            ...
            defSetHtmlText(text1_txv, it.text1?.let { it } ?: it.text1?.let { it }?:let { "" })
            ...
            //com.squareup.picasso.Picasso.with(this@Detail5Activity2).load(android.text.Html.fromHtml(it.image1!!).toString()).into(banner_imv)  ;

            Picasso.with(this@Detail5Activity2).load(Html.fromHtml(it.image_url!!).toString()).placeholder(
                R.drawable.placeholder_image).error(R.drawable.placeholder_image).into(object :
                Target {
                override fun onBitmapLoaded(bitmap: Bitmap, from: Picasso.LoadedFrom) {
                    ...
                    banner_imv.setOnClickListener(View.OnClickListener {
                        ...
                        ImageZoomDialogFragment.showImageDialog(this@Detail5Activity2, bitmap, true)
    ...
    private fun setValues() {
        ...
        appViewModel.appRepository.s_pref.stringLiveData("app_object", "").observe(this,
            Observer { json ->
                ...
                LogUtils.LOGD("niravu", "Detail5Activity2   app_object json=  "+json)
                if(isValid(json)){
    ...
    private fun setBackGrounds(   themeMode: ThemeMode?) {
        ...
        themeMode?.let {
            ...
            it.bg_detail_2?.let {
                ...
                LogUtils.LOGD("niravu", "Detail5Activity2 app_object bg_splash_1=  "+it)
                Picasso.with(this@Detail5Activity2).load(Html.fromHtml(it!!).toString()).placeholder(
