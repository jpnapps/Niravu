...
import kotlinx.android.synthetic.main.rcv_item_home_data_1.view.top_clay
import kotlinx.android.synthetic.main.rcv_item_home_data_2.view.*
import kotlinx.android.synthetic.main.rcv_item_home_data_2.view.top_clay as top_clay_2
//import kotlinx.android.synthetic.main.rcv_item_home_data_4.view.top_clay as top_clay_2
...
import kotlinx.android.synthetic.main.rcv_item_home_data_5.view.top_clay as top_clay_5
...
import kotlinx.android.synthetic.main.rcv_item_home_data_3.view.top_clay as top_clay_3
...
import kotlinx.android.synthetic.main.rcv_item_home_data_6.view.top_clay as top_clay_6

class ItemAdapter (var items: List<MItemData>?, val context: Context, val appViewModel: AppViewModel?,
                   val clickListener: (MItemData?, Int, Int) -> Unit) : RecyclerView.Adapter<BaseViewHolder<MItemData>>(),
    Filterable {

    private  var result_searchlist: List<MItemData> ?=null
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): Filter.FilterResults {
                ...
                if (charString.isEmpty()) {
                    items = result_searchlist as MutableList<MItemData>?
                } else {
                    val filteredList = ArrayList<MItemData>()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: Filter.FilterResults) {
                items = filterResults.values as ArrayList<MItemData>
    ...
    override fun getItemViewType(position: Int): Int {
        val mHomeData: MItemData? = items?.get(position)
        return  mHomeData?.template_id?:-1
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<MItemData> {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<MItemData>, position: Int) {
        try {
...
*/
    ...
    inner class ViewHolderType1 (view: View) : BaseViewHolder<MItemData>(view) {
        override fun bind(
            item: MItemData?,
            clickListener: (MItemData?, Int, Int) -> Unit,
            context: Context,
            position: Int,
            ...
            try {
                ...
                LogUtils.LOGD("list1", "  IAda   click  = "+ item?.custom_field?.clickable)
                if( item?.custom_field?.clickable?:false) {
                    //LogUtils.LOGD("list1", "  IAda   clicked ")
                    itemView.text1_txv.setOnClickListener {

                        LogUtils.LOGD("list1", "  IAda text1_txv   clicked ")
                        clickListener(item, position, 1)
                    }
                    itemView.text2_txv.setOnClickListener {

                        LogUtils.LOGD("list1", "  IAda text2_txv  clicked ")
                        clickListener(item, position, 1)
                           }
                ...
                LogUtils.LOGD("list1", "  IAda ViewHolderType1 = "+item?.template_id)
                item?.let {

                    defSetHtmlText(itemView.text1_txv, item.text1?.let { item.text1 } ?: let { "" })

                  //  it.text2?.substring()
                    defSetHtmlText(itemView.text2_txv, it.text2?.let { it } ?:it.text2?.let { it }?: let { "" })
                    it?.custom_field?.let{
                        ...
                        {
                            setBackGrounds( item.template_id,appViewModel?.appRepository?.prefManager?.getAPPObject(), itemView.text1_txv,itemView.text2_txv,itemView.cardview)
                        ...
                        LogUtils.LOGD("list1", "  SAdapter else  setOnClickListener  ")
                        itemView.setOnClickListener {
                            clickListener(item, position, 1)
                        }
                    }*/
    ...
    inner class ViewHolderType2(itemView: View) : BaseViewHolder<MItemData>(itemView) {
        override fun bind(
            item: MItemData?,
            clickListener: (MItemData?, Int, Int) -> Unit,
            context: Context,
            ...
            try {
                ...
                item?.let {
                    LogUtils.LOGD("list1", "  SAdapter ViewHolderType2 "+item?.template_id)
                   defSetHtmlText(itemView.text1_txv, item.text1?:" ")
                    ...
                    it?.custom_field?.let{
                        ...
                        if(it.clickable) {
                            itemView.top_clay.setOnClickListener {
                                //clickListener(item, position, 1)
                            }
                        }
                    }

                    LogUtils.LOGD("pazham", "Adapter  item.text2  ="+ item.text2)

                    itemView.exrlay.visibility=View.GONE
                    ...
                    if(isValid( item.text2)) {
                        ...
                        item.text2?.isNotBlank()?.let {
                            LogUtils.LOGD("pazham", "Adapter  shuffle_dimv visible   ")
                            itemView.exrlay.visibility=View.VISIBLE
                            defSetText(itemView.text2_txv, item.text2)
                    ...
                    {
                        LogUtils.LOGD("pazham", "Adapter  shuffle_dimv invisibile   ")
                        itemView.shuffle_dimv.visibility = View.INVISIBLE
                        itemView.exrlay.visibility=View.GONE
                    }
    ...
    inner class ViewHolderType3(itemView: View) : BaseViewHolder<MItemData>(itemView) {
        ...
        override fun bind(
            ...
            try {
                LogUtils.LOGD("list1", "  SAdapter ViewHolderType3 "+item?.template_id)
                item?.let {
                    itemView.text2_txv.gravity= Gravity.LEFT
                    defSetHtmlText(itemView.text1_txv, item.text1?:" ")
                    defSetHtmlText(itemView.text2_txv, item.text2?:" ")
    ...
    inner class ViewHolderType4(itemView: View) : BaseViewHolder<MItemData>(itemView) {
                   ...
                   // defSetText(itemView.text1_txv, item.text1?.let { item.text1 } ?: let { "" })
                    ...
                    item.text2?.let {
                       ...
                       // defSetText(itemView.text2_txv, it)
                        defSetHtmlText(itemView.text2_txv,  it?:" ")
                    }?:let{
    ...
    inner class ViewHolderType5(itemView: View) : BaseViewHolder<MItemData>(itemView) {
           ...
           /*         defSetText(itemView.text1txv, item.text1?.let { item.text1 } ?: let { "" })
                    ...
                    it?.custom_field?.let {
                        if (it.design_override) {
                            ...
                            setBackGrounds(
                                item.template_id,
                                appViewModel?.appRepository?.prefManager?.getAPPObject(),
                                itemView.text1_txv,
                                itemView.text2_txv,
                                itemView.cardview
                            )
    ...
    //----------------ViewHolderType6 | Image-------------
    inner class ViewHolderType6(itemView: View) : BaseViewHolder<MItemData>(itemView) {
        ...
        override fun bind(
            ...
            try {
                item?.let {
                   ...
                   // defSetHtmlText(itemView.text2_txv, item.text2?:" ")
                    it?.custom_field?.let{
                        ...
                        {
                            setBackGrounds( item.template_id,appViewModel?.appRepository?.prefManager?.getAPPObject(), itemView.text1_txv,null,itemView.cardview,menu_bg_dimv = itemView.menu_bg_dimv)
                       ...
                       /* if(it.clickable) {
                            itemView.setOnClickListener {
                                LogUtils.LOGD("niravu", "Adapter partItemClicked  ViewHolderType6 ")
                                clickListener(item, position, 1)
                            }
                        }*/
                    }
                ...
                e.message
                LogUtils.LOGD("niravu", "Adapter ViewHolderType6  ex = "+e.message)
            }
        }
    }

    //----------------ViewHolderType30 | Image-------------
    inner class ViewHolderType30(itemView: View) : BaseViewHolder<MItemData>(itemView) {
...
/*
        ...
        fun onSetAdapter(items: List<MItemData>?=null, rcv: RecyclerView) {
            child_adapter = CardMenu1Adapter(items, context,appViewModel, { mgame : MItemData?, postion:Int, purpose:Int  -> partItemClicked(mgame,postion,purpose) })
...
*/
    ...
    inner class BannerViewHolderType10(itemView: View) : BaseViewHolder<MItemData>(itemView) {
        ...
        override fun bind(
            ...
            try {
                ...
                item?.let {
                    ...
                    it?.custom_field?.let {
                        it.banner_list?.let {
                            setAdsDatas(itemView.img_slideview,it,context,appViewModel)
                        }
    ...
    inner class BannerViewHolderType11(itemView: View) : BaseViewHolder<MItemData>(itemView) {
