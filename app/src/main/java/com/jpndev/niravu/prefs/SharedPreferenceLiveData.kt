...
/*class SharedPreferenceMayStringLiveData(sharedPrefs: SharedPreferences, key: String, defValue: String?) :
    SharedPreferenceLiveData<String>(sharedPrefs, key, defValue?:"") {
    override fun getValueFromPreferences(key: String, defValue: String): String= sharedPrefs.getString(key, defValue)?:defValue
}*/
...
/*
fun SharedPreferences.stringMayLiveData(key: String, defValue: String?): SharedPreferenceLiveData<String> {
    return SharedPreferenceStringLiveData(this, key, defValue)
}
*/
