 ...
 */
public class JpFlowLayout extends ViewGroup {
    ...
    public JpFlowLayout(Context context) {
        this(context, null);
    }

    public JpFlowLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public JpFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void initAttr(Context context, AttributeSet attributeSet, int defStyle) {
        TypedArray a =
                context.obtainStyledAttributes(attributeSet, R.styleable.JpFlowLayout, defStyle, 0);
        try {
            orientation = a.getInt(R.styleable.JpFlowLayout_flow_orientation, ORIENTATION_HORIZONTAL);
            gravity = a.getInt(R.styleable.JpFlowLayout_gravity, GRAVITY_NONE);
            verticalSpacing =
                    a.getDimensionPixelSize(R.styleable.JpFlowLayout_verticalSpacing, SPACING_NONE);
            horizontalSpacing =
                    a.getDimensionPixelSize(R.styleable.JpFlowLayout_horizontalSpacing, SPACING_NONE);
        } finally {
            a.recycle();
        }
    }
    ...
    public static class LayoutParam extends MarginLayoutParams {
        ...
        public LayoutParam(Context context, AttributeSet attributeSet) {
            ...
            TypedArray a = context.obtainStyledAttributes(attributeSet,
                    R.styleable.JpFlowLayout, 0, 0);
            try {
                weight = a.getInt(R.styleable.JpFlowLayout_weight, 0);
                lineNum = a.getInt(R.styleable.JpFlowLayout_lineNum, LINE_NUM_INVALID);
                horizontalSpacing =
                        a.getDimensionPixelSize(R.styleable.JpFlowLayout_childHorizontalSpacing, SPACING_NONE);
                verticalSpacing =
                        a.getDimensionPixelSize(R.styleable.JpFlowLayout_childVerticalSpacing, SPACING_NONE);
            } finally {
                a.recycle();
            }
        }
