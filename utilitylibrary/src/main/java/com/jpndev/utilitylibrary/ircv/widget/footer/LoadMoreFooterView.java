package com.jpndev.utilitylibrary.ircv.widget.footer;
...
public class LoadMoreFooterView extends FrameLayout {
    ...
    public boolean canLoadMore() {
        return mStatus == Status.GONE || mStatus == Status.ERROR|| mStatus == Status.START ;
    }
    ...
    public enum Status {
        GONE, LOADING, ERROR, THE_END , START
    }
